...
class SaleSidePanelView extends TPage
{
    ...
    public function onView($param)
    {
        try
        {
            ...
            $label_id = new TLabel('Mesa:', '#333333', '12px', 'b');
            ...
            $text_id  = new TTextDisplay($master_object->mesa, '#333333', '12px', '');
           ...
           // $this->form->addFields([$label_customer_id],[$text_customer_id]);
            ...
            $total         = new TDataGridColumn('={amount} * ( {sale_price} - {discount} )',  'Total',    'right');
